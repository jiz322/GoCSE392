...
To use a game of your choice, subclass the classes in ```Game.py``` and ```NeuralNet.py``` and implement their functions. Example implementations for Go can be found in ```go/Game.py``` and ```go/{pytorch,keras,tensorflow,chainer}/NNet.py```. 
