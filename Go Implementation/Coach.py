...
class Coach():
    ...
    def learn(self):
        ...
        for i in range(1, self.args.numIters + 1):
            ...
            self.n2net.load_checkpoint(folder=self.args.checkpoint, filename='best.pth.tar') 
            self.n3net.load_checkpoint(folder=self.args.checkpoint, filename='best.pth.tar') 
            ...
            self.n3net.save_checkpoint(folder=self.args.checkpoint, filename='temp.pth.tar')
            self.n4net.load_checkpoint(folder=self.args.checkpoint, filename='best.pth.tar') #Load n3 result, see if it perform better
            shuffle(trainExamples)              
            ...
            nnList = [self.pnet, self.nnet, self.n2net, self.n3net, self.n4net]
